...
## [⬇ 最新のカスタム版をダウンロード（Windows / macOS）](https://github.com/asd260531078/cc-switch-custom/releases/latest)
...
このカスタム版は公式 v3.20.4 に Claude Desktop インポート修正を追加しています。署名とインストールの注意事項はリリースページをご覧ください。以下の Homebrew・Linux 手順は公式版向けです。
